...
#load images
bg_img = pygame.image.load('background_02.jpg')
bg2_img = pygame.image.load('background_02.jpg')
bg2_img = pygame.transform.scale(bg2_img, (screen_width, screen_height - margin))
bg_img = pygame.transform.scale(bg_img, (screen_width, screen_height - margin))
dirt_img = pygame.image.load('tile2.png')
grass_img = pygame.image.load('tile.png')
blob_img = pygame.image.load('ghost.png')
exit_img = pygame.image.load('gate2.png')
save_img = pygame.image.load('save_btn.png')
load_img = pygame.image.load('load_btn.png')
ghost2_img = pygame.image.load('ghost3.png')
		...
		for col in range(35):
			if world_data[row][col] > 0:
				...
				if world_data[row][col] == 5:
					#enemy blocks
					img = pygame.transform.scale(ghost2_img, (tile_size, int(tile_size * 0.75)))
					screen.blit(img, (col * tile_size, row * tile_size + (tile_size * 0.25)))
				if world_data[row][col] == 6:
					#enemy blocks
					img = pygame.transform.scale(coin_img, (tile_size, int(tile_size * 0.75)))
					screen.blit(img, (col * tile_size, row * tile_size + (tile_size * 0.25)))     					
